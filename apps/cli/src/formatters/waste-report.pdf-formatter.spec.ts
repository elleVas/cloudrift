...
function allKindFindings(): WastedResource[] {
  return [
    ...
    new Workspace({ workspaceId: 'ws-1', region, accountId, computeTypeName: 'STANDARD', runningMode: 'ALWAYS_ON', lastKnownUserConnectionTimestamp: undefined, detectedAt: now, tags, monthlyCostUsd: 35 }),
