// Genera libs/shared/aws-infra-utils/dist-pkg/package.json per la
// pubblicazione su GitHub Packages, ad uso di repo privati esterni (es. il
// futuro modulo drift-detector Terraform) che non fanno parte di questo
// workspace pnpm/Nx.
//
// Il pacchetto interno (libs/shared/aws-infra-utils/package.json) resta
// "private" e con nome non-scoped ("shared-aws-infra-utils") esattamente
// com'era: questo script non lo tocca, produce solo un manifest di
// pubblicazione parallelo con un nome diverso (scoped, richiesto da GitHub
// Packages) a partire dal bundle esbuild (bundle:true, thirdParty:false —
// le lib del workspace come shared-kernel sono già inlinate in index.js).
